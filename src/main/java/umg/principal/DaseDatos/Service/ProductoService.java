...
public class ProductoService {
    ...
    public String opteneropciopon(String E) throws SQLException{
        return productoDAO.opciondeconsulta(E);
    }

    public List<Producto> obtenerGenericos(String a) throws SQLException {
        return productoDAO.obtenerGenericos(a);
    }
